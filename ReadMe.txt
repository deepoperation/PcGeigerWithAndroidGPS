========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : BlackCatWithGPS
========================================================================


AppWizard が生成した BlackCatWithGPS には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには BlackCatWithGPS を構成している各ファイルの概要説明が含まれています。
...
BlackCatWithGPS.h
    ...
    みます） をインクルードし、また CBlackCatWithGPSApp アプリケーションクラスを宣
    言します。

BlackCatWithGPS.cpp
    このファイルは CBlackCatWithGPSApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\BlackCatWithGPS.ico
    このファイルは、アプリケーションのアイコンとして使用されるアイコンファイ
    ルです。このアイコンはリソース ファイル BlackCatWithGPS.rc によってインクルード
    されます。

res\BlackCatWithGPS.rc2
...
BlackCatWithGPSDlg.h, BlackCatWithGPSDlg.cpp - ダイアログ
    これらのファイルは CBlackCatWithGPSDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な BlackCatWithGPS.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) BlackCatWithGPS.pch 
